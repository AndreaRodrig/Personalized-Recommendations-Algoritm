...
The goal is to identify products and departments with high purchase affinity for each customer, separating the analysis into High-Ticket and Low-Ticket categories.
